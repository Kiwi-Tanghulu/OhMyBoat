public partial class ShipInfoPanel
{
	public class DisplayFormat
    {
        ...
        public const string TopSpeedFormat = "TOP SPEED : {0} m/s";
        public const string AccelSpeedFormat = "ACCEL SPEED : {0} m/s^2";
        public const string WeightFormat = "WEIGHT : {0} kg";
    }
}
